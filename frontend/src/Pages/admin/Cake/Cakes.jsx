...
export default function Cakes() {
  ...
  const openDeleteModal = (id, cakeName) => {
    setModalConfig({
      isOpen: true,
      cakeId: id,
      cakeName: cakeName
  ...
  const confirmDelete = () => {
    if (modalConfig.cakeId) {
      deleteCake(modalConfig.cakeId);
    }
  };
  ...
  return (
    <div className="flex h-screen bg-[#EFE6E2] overflow-hidden">
                      ...
                      <td className="py-3 px-3">
                        <div className="flex items-center gap-3">
                          ...
                          <button
                            ...
                            title="Delete"
                            onClick={() =>
                              openDeleteModal(cake.id, cake.name)
                            }
                            className="bg-transparent p-1 rounded-full
      ...
      <ConfirmationModal
        ...
        title="Delete Cake"
        message={`Are you sure you want to delete "${modalConfig.cakeName}"? This action cannot be undone.`}
